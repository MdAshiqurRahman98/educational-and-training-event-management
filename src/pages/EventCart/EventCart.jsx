            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-9 mt-7 mb-11">
                {
                    displayServices.map(service => <div key={service.id} className="card rounded-lg p-5 bg-[#F8F8F8] h-96">
                        ...
                        <div className="text-center">
                            <h3 className="text-xl font-bold text-center mt-3 mb-1 px-2 py-[2px]">{service.name}</h3>
                            <p className="text-left mb-1">{service.short_description}</p>
                            <p className="text-sm font-semibold text-center mt-2 mb-1">Price: ${service.price}.00</p>
